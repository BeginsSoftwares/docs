...
description: "Endpoint para iniciar processo de abertura de conta completa"
---

## POST /sub-accounts/open-full-account

Inicia o processo de abertura de conta completa na Woovi (processador de pagamento).
...
- ✅ **Integração Woovi**: Registra conta no processador de pagamento
